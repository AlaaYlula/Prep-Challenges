...
const objectCounter = (obj) => {
    ...
    let num = obj.reduce((previousValue, currentValue, currentIndex)=>
    {
        return currentIndex++;
    },0);
        return (num+1);
...
const stringReverse = (str) => {
    ...
    let newword = wordsArray.reduce((previousValue, currentValue, currentIndex) =>
    {
